...
public class PlayCard extends CardSet {
    ...
    //根据所给的myCard的长度来查询牌型
    public static CardType checkType(List<Card> myCard) {
        CardSet.sortCard(myCard);
        ...
        switch (myCard.size()) {
            case 1:
                ...
                break;
            case 2:
                if (maxCount(myCard) == 2) {
                    cardType = CardType.values()[2]; //对牌
                } else if (myCard.get(0).val == 14 && myCard.get(1).val == 15) {
            ...
            case 5:
                if (maxCount(myCard) == 3) {
                    if (checkCount(myCard, myCard.get(0).val) == 2 || checkCount(myCard, myCard.get(4).val) == 2) {
                        cardType = CardType.values()[5];
                    }
                } else if (checkSZ(myCard)) {
            ...
            case 8:
                if (maxCount(myCard) == 4) {
                    ...
                    cardType = CardType.values()[9];
                } else if (checkLD(myCard)) {
                    cardType = CardType.values()[10];
                } else if (checkFJ1(myCard)) {
    ...
    public static boolean judge(PlayCard myCards, PlayCard formalCards) {
        myCards.cardType = PlayCard.checkType(myCards.getList());
        formalCards.cardType = PlayCard.checkType(formalCards.getList());
